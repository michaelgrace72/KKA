function redirectToResultPage(event) {
	...
	const graph = {
		...
		'R2': {
			...
			'PENS 2': {'Kejawan Putih Tambak': 1200, 'PENS 1': 50},
		},
	...
	function findRoute(startRute, endRute, startHalte, endHalte) {
		...
		if (startRute === goalRute) {
			const pathToGoal = astar(graph[currentRute], startHalte, endHalte, allHeuristics);
			if (pathToGoal) {
...
let locations = ["KENPARK",
    ...
    "Rungkut Madya 2",
    "Gunung Anyar Lor 2",
    "Gunung Anyar Timur 2",
    "Gunung Anyar Timur 1",
    "Gunung Anyar Lor 1",
    "Rungkut Madya 1",
    "Pandugo 1",
    "Sentra UKM MERR",
